...
import { LogOut, Hash, Shield, Clock, CalendarDays, BarChart2, MessageSquare, X } from 'lucide-react';
              ...
              <nav className="space-y-1 px-2">
                {channels.map(channel => (
                  <button
                    ...
                    className={`w-full flex items-center gap-3 px-3 py-2 rounded-md transition-colors ${activeChannelId === channel.id
